...
namespace BaseApp_Projemiz
{
    public partial class Form7 : Form
    {
        ...
        public string[] vakıf_bank = { "İş Bankası", "Garanti Bankası", "Ziraat Bankası" };
        public string[] is_bankasi = { "VakıfBank", "Garanti Bankası", "Ziraat Bankası" };
        ...
        public string[] garanti_bankasi = { "VakıfBank", "İş Bankası", "Ziraat Bankası" };
        public string[] ziraat_bankasi = { "VakıfBank", "İş Bankası", "Garanti Bankası"  };
        ...
        private void Form7_Load(object sender, EventArgs e)
        {
            ...
            {  // Banka isimleri fotoğrafın altında düzgün gözüksün diye lokasyon ve combobox ayarlaması..
                if (label_banka.Text.Equals("VakıfBank"))
                {
                    label_banka.Location = new Point(480, 141);
                    comboBox1.Items.AddRange(vakıf_bank);              
                }

                else if (label_banka.Text.Equals("İş Bankası"))
                {
                    label_banka.Location = new Point(480, 141);
                    comboBox1.Items.AddRange(is_bankasi);
                }

                else if (label_banka.Text.Equals("Ziraat Bankası"))
                {
                    label_banka.Location = new Point(462, 141);
                    comboBox1.Items.AddRange(ziraat_bankasi);
                }

                else if (label_banka.Text.Equals("Garanti Bankası"))
                {
                    label_banka.Location = new Point(453, 141);
                    comboBox1.Items.AddRange(garanti_bankasi);
                }
            }



            //burada eğer bakiye yetmezse bidahaki form açılışında textboxa göre bankanın gelmesi için yazılmıştır.
            {

                if (textBox_hesapNo.TextLength > 2)
                {

                    if (label_banka.Text.Equals("VakıfBank"))
                    {

                        if (textBox_hesapNo.Text.Substring(0, 3).Equals("222"))
                        {
                            comboBox1.SelectedIndex = 0;
                         
                        }
                        if (textBox_hesapNo.Text.Substring(0, 3).Equals("333"))
                        {
                            comboBox1.SelectedIndex = 1;
                        }
                        if (textBox_hesapNo.Text.Substring(0, 3).Equals("444"))
                        {
                    ...
                    {
                        if (textBox_hesapNo.Text.Substring(0, 3).Equals("111"))
                        {
                            comboBox1.SelectedIndex = 0;
                        }
                        if (textBox_hesapNo.Text.Substring(0, 3).Equals("333"))
        ...
        private void textBox_hesapNo_TextChanged(object sender, EventArgs e)
        {
            // burada yaptığım şey hesap numarasının ilk üç harfinden kullanıcı bankasını tanımaktır
            ...
            if (textBox_hesapNo.TextLength>2)
            {
                ...
                if (label_banka.Text.Equals("VakıfBank"))
                {
                    ...
                    else if (textBox_hesapNo.Text.Substring(0,3).Equals("333"))
                    {
                        comboBox1.SelectedIndex = 1;
                    }
                    else if (textBox_hesapNo.Text.Substring(0, 3).Equals("444"))
                    {
                        comboBox1.SelectedIndex = 2;
                    }
                    else
                ...
                else if (label_banka.Text.Equals("Garanti Bankası"))
                {
                    ...
                    else if (textBox_hesapNo.Text.Substring(0, 3).Equals("222"))
                    {
                        comboBox1.SelectedIndex = 1;
                    }
                    else if (textBox_hesapNo.Text.Substring(0, 3).Equals("444"))
        ...
        {           
            ...
            else if (label_miktar.Text.Equals("0") && textBox_hesapNo.Text.Length<6 && comboBox1.Text == "")
            {
                MessageBox.Show("Lütfen EFT yapılacak altı haneli hesap numarasını ve EFT tutarını giriniz, ardından EFT yapılacak bankayı seçiniz.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
          
            else if (label_miktar.Text.Equals("0") && textBox_hesapNo.Text.Length<6)
            {
                MessageBox.Show("Lütfen EFT yapılacak altı haneli hesap numarasını ve EFT tutarını giriniz.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }

            else if (label_miktar.Text.Equals("0") && comboBox1.Text == "")
            {
                MessageBox.Show("Lütfen EFT tutarını giriniz ve EFT yapılacak bankayı seçiniz.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }

            else if (textBox_hesapNo.Text.Length<6 && comboBox1.Text == "")
            {
                MessageBox.Show("Lütfen EFT yapılacak altı haneli hesap numarasını giriniz ve EFT yapılacak bankayı seçiniz.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }

            else if (label_miktar.Text.Equals("0"))
            {
                MessageBox.Show("Lütfen EFT tutarını giriniz", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }

            else if (textBox_hesapNo.Text.Length<6)
            {
                MessageBox.Show("Lütfen EFT yapılacak altı haneli hesap numarasını giriniz", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }

            else if (comboBox1.Text == "")
            {
                MessageBox.Show("Lütfen EFT yapılacak bankayı seçiniz", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }

            else
            {
                SqlCommand komut2 = new SqlCommand("Select banka, bakiye, para_miktar_5, para_miktar_10, para_miktar_20, para_miktar_50, para_miktar_100, para_miktar_200,"+"" +
                    " kullanici_adi From kullanici_bilgileri where hesap_no=@p1", bgl.baglanti());
                ...
                while (dr.Read())
                {
                    ...
                    maxEft = 6000 - (Convert.ToInt32(bakiye2));
                }
                bgl.baglanti().Close();
                ...
                if (textBox_hesapNo.Text.Equals(label_hesapNo.Text))
                {
                    MessageBox.Show("Girdiğiniz hesap numarası size ait, kendinize EFT gönderemezsiniz.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }

                else if (comboBox1.Text.Equals(banka2) == false)
                {
                    MessageBox.Show("Seçtiğiniz bankaya ait '" + textBox_hesapNo.Text + "' nolu kullanıcı bulunamadı. \nLütfen EFT yapacağınız hesap numarasını ve gönderdiğiniz bankayı kontrol edip tekrar deneyiniz.", "Uyarı !", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }

                else if (Convert.ToInt32(label_miktar.Text) > maxEft)
                {
                    MessageBox.Show(textBox_hesapNo.Text + " nolu hesaba;\nGönderebileceğiniz maksimum EFT miktarı: " + maxEft + " TL'dir.", "EFT Gönderimi Başarısız !", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    ...
                    {
                        form7.gizleToolStripMenuItem.Checked = true;
                        form7.gösterToolStripMenuItem.Checked = false;
                    }
                    else
                    {
                        form7.gösterToolStripMenuItem.Checked = true;
                        form7.gizleToolStripMenuItem.Checked = false;
                        form7.Size = new Size(667, 680);
                    }
                    form7.kullaniciAdi = kullaniciAdi;
                    form7.textBox_hesapNo.Text = textBox_hesapNo.Text.ToString();  
                    form7.Show();
                }
...
*/
                ...
                else
                {
                    ...
                    SqlCommand komut = new SqlCommand("Update kullanici_bilgileri set bakiye=@d1, para_miktar_5=@d2, para_miktar_10=@d3, para_miktar_20=@d4, para_miktar_50=@d5, para_miktar_100=@d6, para_miktar_200=@d7 where kullanici_adi=@d8 ", bgl.baglanti());
                    ...
                    SqlCommand komut3 = new SqlCommand("Update kullanici_bilgileri set bakiye=@d1, para_miktar_5=@d2, para_miktar_10=@d3, para_miktar_20=@d4, para_miktar_50=@d5, para_miktar_100=@d6, para_miktar_200=@d7 where hesap_no=@d8 ", bgl.baglanti());
                    ...
                    SqlCommand komut4 = new SqlCommand("insert into hesap_hareketleri (kullanici_adi, islem_tarih, aciklama, tutar, bakiye) values (@p1, @p2, @p3, @p4, @p5) ", bgl.baglanti());

                    komut4.Parameters.AddWithValue("@p1", kullaniciAdi);
                    komut4.Parameters.AddWithValue("@p2", datetime);
                    komut4.Parameters.AddWithValue("@p3", "EFT");
                    ...
                    SqlCommand komut5 = new SqlCommand("insert into hesap_hareketleri (kullanici_adi, islem_tarih, aciklama, tutar, bakiye) values (@p1, @p2, @p3, @p4, @p5) ", bgl.baglanti());

                    komut5.Parameters.AddWithValue("@p1", kullaniciAdi2);
                    komut5.Parameters.AddWithValue("@p2", datetime);
                    komut5.Parameters.AddWithValue("@p3", "EFT");
                    ...
                    MessageBox.Show("Hesabınızdan " + textBox_hesapNo.Text + " Nolu Hesaba " + label_miktar.Text + " TL EFT gerçekleştirilmiştir", "EFT Gönderimi Başarılı", MessageBoxButtons.OK, MessageBoxIcon.Information);
