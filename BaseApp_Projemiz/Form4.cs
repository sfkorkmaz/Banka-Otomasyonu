...
namespace BaseApp_Projemiz
{
    public partial class Form4 : Form
    {
        ...
        private void Form4_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand("Select isim, hesap_no, bakiye, banka, para_miktar_5, para_miktar_10, para_miktar_20, para_miktar_50, para_miktar_100, " +
                " para_miktar_200 From kullanici_bilgileri where kullanici_adi=@p1", bgl.baglanti());
        ...
        {         
            if (label_adet_5.Text.Equals("200"))
            {
                MessageBox.Show("200 adet sınırına ulaştınız. Daha fazla 5'lik banknot alamazsınız.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen yatırılacak tutarı giriniz", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }

            else
            {
                label_bakiye.Text = ((Convert.ToInt32(label_miktar.Text)) + (Convert.ToInt32(label_bakiye.Text))).ToString();
                ...
                MessageBox.Show("Hesabınıza " + label_miktar.Text + " TL para yatırılmıştır.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);

                SqlCommand komut = new SqlCommand("Update kullanici_bilgileri set bakiye=@d1, para_miktar_5=@d2, para_miktar_10=@d3"+
                    ", para_miktar_20=@d4, para_miktar_50=@d5, para_miktar_100=@d6, para_miktar_200=@d7 where kullanici_adi=@d8 ", bgl.baglanti());
                ...
                //hesap hareketleri tarih işlemleri
                ...
                SqlCommand komut2 = new SqlCommand("insert into hesap_hareketleri (kullanici_adi, islem_tarih,"+ 
                    "aciklama, tutar, bakiye) values (@p1, @p2, @p3, @p4, @p5) ", bgl.baglanti());

                komut2.Parameters.AddWithValue("@p1", kullaniciAdi);
                komut2.Parameters.AddWithValue("@p2",  datetime);
                komut2.Parameters.AddWithValue("@p3", "Para Yatırma");
        ...
        {
            if (label_adet_10.Text.Equals("100"))
            { 
                MessageBox.Show("100 adet sınırına ulaştınız. Daha fazla 10'luk banknot alamazsınız.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            if (label_adet_20.Text.Equals("50"))
            {
                MessageBox.Show("50 adet sınırına ulaştınız. Daha fazla 50'lik banknot alamazsınız.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            if (label_adet_50.Text.Equals("20"))
            {
                MessageBox.Show("20 adet sınırına ulaştınız. Daha fazla 50'lik banknot alamazsınız.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            if (label_adet_100.Text.Equals("10"))
            {
                MessageBox.Show("10 adet sınırına ulaştınız. Daha fazla 100'lük banknot alamazsınız.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            if (label_adet_200.Text.Equals("5"))
            {
                MessageBox.Show("5 adet sınırına ulaştınız. Daha fazla 200'lük banknot alamazsınız.", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Information);
